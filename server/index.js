...
//const constr='mongodb+srv://admin:csse4103@postitcluster.ghr1x1p.mongodb.net/PostITDb?appName=PostITCluster'
const constr = `mongodb+srv://${process.env.DB_USERNAME}:${process.env.DB_PASSWORD}@postitcluster.ghr1x1p.mongodb.net/${process.env.DB_NAME}?appName=PostITCluste`;
